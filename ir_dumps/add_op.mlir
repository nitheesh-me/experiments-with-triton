...
#loc = loc("examples/kernels/binary_ops.py":73:0)
module {
  tt.func public @add_kernel(%arg0: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("examples/kernels/binary_ops.py":73:0), %arg1: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("examples/kernels/binary_ops.py":73:0), %arg2: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("examples/kernels/binary_ops.py":73:0), %arg3: i32 {tt.divisibility = 16 : i32} loc("examples/kernels/binary_ops.py":73:0)) attributes {noinline = false} {
...
#loc1 = loc("examples/kernels/binary_ops.py":80:24)
#loc2 = loc("examples/kernels/binary_ops.py":81:24)
#loc3 = loc("examples/kernels/binary_ops.py":82:41)
#loc4 = loc("examples/kernels/binary_ops.py":82:28)
#loc5 = loc("examples/kernels/binary_ops.py":84:21)
#loc6 = loc("examples/kernels/binary_ops.py":86:24)
#loc7 = loc("examples/kernels/binary_ops.py":86:16)
#loc8 = loc("examples/kernels/binary_ops.py":87:24)
#loc9 = loc("examples/kernels/binary_ops.py":87:16)
#loc10 = loc("examples/kernels/binary_ops.py":88:17)
#loc11 = loc("examples/kernels/binary_ops.py":89:26)
#loc12 = loc("examples/kernels/binary_ops.py":89:35)
#loc13 = loc("examples/kernels/binary_ops.py":89:4)
...
#loc1 = loc(unknown)
#loc2 = loc("examples/kernels/binary_ops.py":80:24)
#loc3 = loc("examples/kernels/binary_ops.py":81:24)
#loc4 = loc("examples/kernels/binary_ops.py":82:41)
#loc5 = loc("examples/kernels/binary_ops.py":82:28)
#loc6 = loc("examples/kernels/binary_ops.py":84:21)
#loc7 = loc("examples/kernels/binary_ops.py":86:24)
#loc8 = loc("examples/kernels/binary_ops.py":86:16)
#loc9 = loc("examples/kernels/binary_ops.py":87:24)
#loc10 = loc("examples/kernels/binary_ops.py":87:16)
#loc11 = loc("examples/kernels/binary_ops.py":88:17)
#loc12 = loc("examples/kernels/binary_ops.py":89:26)
#loc13 = loc("examples/kernels/binary_ops.py":89:35)
#loc14 = loc("examples/kernels/binary_ops.py":89:4)
...
module attributes {ttg.global_scratch_memory_alignment = 1 : i32, ttg.global_scratch_memory_size = 0 : i32, "ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.shared = 0 : i32, ttg.target = "cuda:89", ttg.tensor_memory_size = 0 : i32, "ttg.threads-per-warp" = 32 : i32, "ttg.total-num-warps" = 4 : i32} {
  tt.func public @add_kernel(%arg0: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("examples/kernels/binary_ops.py":73:0), %arg1: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("examples/kernels/binary_ops.py":73:0), %arg2: !tt.ptr<f32> {tt.divisibility = 16 : i32} loc("examples/kernels/binary_ops.py":73:0), %arg3: i32 {tt.divisibility = 16 : i32} loc("examples/kernels/binary_ops.py":73:0)) attributes {noinline = false, ttg.global_scratch_memory_alignment = 1 : i32, ttg.global_scratch_memory_size = 0 : i32} {
    %c1024_i32 = arith.constant 1024 : i32 loc(#loc1)
    %0 = tt.get_program_id x : i32 loc(#loc2)
    %1 = arith.muli %0, %c1024_i32 : i32 loc(#loc3)
    %2 = tt.make_range {end = 1024 : i32, start = 0 : i32} : tensor<1024xi32, #blocked> loc(#loc4)
...
module attributes {ttg.global_scratch_memory_alignment = 1 : i32, ttg.global_scratch_memory_size = 0 : i32, "ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.shared = 0 : i32, ttg.target = "cuda:89", ttg.tensor_memory_size = 0 : i32, "ttg.threads-per-warp" = 32 : i32, "ttg.total-num-warps" = 4 : i32} {
  ...
  llvm.func @add_kernel(%arg0: !llvm.ptr<1> {tt.divisibility = 16 : i32} loc("examples/kernels/binary_ops.py":73:0), %arg1: !llvm.ptr<1> {tt.divisibility = 16 : i32} loc("examples/kernels/binary_ops.py":73:0), %arg2: !llvm.ptr<1> {tt.divisibility = 16 : i32} loc("examples/kernels/binary_ops.py":73:0), %arg3: i32 {tt.divisibility = 16 : i32} loc("examples/kernels/binary_ops.py":73:0), %arg4: !llvm.ptr<1> loc("examples/kernels/binary_ops.py":73:0)) attributes {noinline = false, nvvm.kernel = 1 : ui1, nvvm.reqntid = array<i32: 128>, ttg.global_scratch_memory_alignment = 1 : i32, ttg.global_scratch_memory_size = 0 : i32} {
